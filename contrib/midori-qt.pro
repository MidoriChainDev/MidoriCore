...
RESOURCES += src/qt/midori.qrc src/qt/midori_locale.qrc

TRANSLATIONS += src/qt/locale/midori_bg.ts \
                src/qt/locale/midori_de.ts \
                src/qt/locale/midori_en.ts \
                src/qt/locale/midori_es.ts \
                src/qt/locale/midori_fi.ts \
                src/qt/locale/midori_fr.ts \
                src/qt/locale/midori_it.ts \
                src/qt/locale/midori_ja.ts \
                src/qt/locale/midori_pl.ts \
                src/qt/locale/midori_pt.ts \
                src/qt/locale/midori_ru.ts \
                src/qt/locale/midori_sk.ts \
                src/qt/locale/midori_sv.ts \
                src/qt/locale/midori_vi.ts \
                src/qt/locale/midori_zh_CN.ts \
                src/qt/locale/midori_zh_TW.ts
