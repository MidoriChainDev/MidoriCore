...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Midori to zMidori");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zMidori");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Midori from zMidori");
    case TransactionRecord::ZerocoinSpend_Change_zMidori:
        return tr("Minted Change as zMidori from zMidori Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zMidori to Midori");
