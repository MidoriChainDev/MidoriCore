                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Midori Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Midori address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and midori: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMDR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Midori Core"), this);
    aboutAction->setStatusTip(tr("Show information about Midori Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Midori"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Midori addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Midori addresses"));
    ...
    openAction->setStatusTip(tr("Open a Midori: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Midori Core help message to get a list with possible Midori command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Midori Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Midori network", "", count));
}
...
{
    QString strTitle = tr("Midori Core"); // default title
...
/** Creates context menu, its actions, and midoris up all the relevant signals for mouse events. */
