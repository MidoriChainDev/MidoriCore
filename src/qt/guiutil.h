...
/** Utility functions used by the Midori Qt UI.
 */
namespace GUIUtil
{
...
// Render Midori addresses in monospace font
...
// Parse "midori:" URI into recipient object, return true on successful parsing
