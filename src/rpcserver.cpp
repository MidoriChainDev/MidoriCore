...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Midori features */
        {"midori", "masternode", &masternode, true, true, false},
        {"midori", "listmasternodes", &listmasternodes, true, true, false},
        {"midori", "getmasternodecount", &getmasternodecount, true, true, false},
        {"midori", "masternodeconnect", &masternodeconnect, true, true, false},
        {"midori", "masternodecurrent", &masternodecurrent, true, true, false},
        {"midori", "masternodedebug", &masternodedebug, true, true, false},
        {"midori", "startmasternode", &startmasternode, true, true, false},
        {"midori", "createmasternodekey", &createmasternodekey, true, true, false},
        {"midori", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"midori", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"midori", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"midori", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"midori", "getmasternodescores", &getmasternodescores, true, true, false},
        {"midori", "mnbudget", &mnbudget, true, true, false},
        {"midori", "preparebudget", &preparebudget, true, true, false},
        {"midori", "submitbudget", &submitbudget, true, true, false},
        {"midori", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"midori", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"midori", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"midori", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"midori", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"midori", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"midori", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"midori", "checkbudgets", &checkbudgets, true, true, false},
        {"midori", "mnsync", &mnsync, true, true, false},
        {"midori", "spork", &spork, true, true, false},
        {"midori", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"midori", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use midorid, or the -server option to midori-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> midori-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50510/\n";
}
