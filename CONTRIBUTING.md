Contributing to Midori Core
============================

The Midori Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Midori Core project, and is not to be
confused with overall Midori Network Protocol consensus changes.

Whether a pull request is merged into Midori Core rests with the project merge
...
Patches that change Midori consensus rules are considerably more involved than
...
Where a patch set proposes to change the Midori consensus, it must have been
...
The project leader is the release manager for each Midori Core release.
