...
In order to support loading of multiple wallets in midori-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is midori.cpp.
...
Changes to midori.cpp
----------------------
midori.cpp is the entry point into midori-qt, and as such, will require some minor modifications to provide hooks for
